...
public class GetUserByIdFeature {
    ...
    // Se pone la misma linea de caracters del archivo GetUserByID.feature para que Cucumber lo relaciones
    ...
    // When -> relacion a un evento que se producia
    ...
    //Then -> El que hace el test en si, tiene mas assert's
